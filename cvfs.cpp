...
void InitialiseUAREA()
{
    ...
    cout<<"Aditya CVFS : UAREA initialised succesfully\n";
}
...
void InitialiseSuperblock()
{
    ...
    cout<<"Aditya CVFS : Superblock initialised succesfully\n";
}
...
void CreateDILB()
{
    ...
    cout<<"Aditya CVFS : DILB created succesfully\n";
}
...
void StartAuxilaryDataInitialisation()
{
    ...
    cout<<"Aditya CVFS : Auxilary data initalised succesfully\n";
}
...
{
    printf("---------------------------------------------------------\n");
    printf("----------- Command Manual of Aditya CVFS -----------\n");
    printf("---------------------------------------------------------\n");

    printf("man : It is used to display the specific manual page of command\n");
    printf("exit : It is used to terminate the shell of Aditya CVFS\n");
    printf("clear : It is used to clear the console of Aditya CVFS\n");
            ...
            )
{
    ...
    {
        printf("Description : This command is used to terminate the Aditya CVFS\n");
...
int main()
{
    ...
    cout<<"---------------------------------------------------------\n";
    cout<<"--------- Aditya CVFS Started Succesfully ------------\n";
    cout<<"----------------------------------------------------------\n";
    ...
    while(1)
    {
        ...
        if(iCount == 1)
        {
            ...
            {
                printf("Thank you for using Aditya CVFS\n");
        ...
        {
            // Aditya CVFS > creat Ganesh.txt 3
